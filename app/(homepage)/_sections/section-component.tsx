...
export const SectionComponent = () => {
    return (
        <section className="flex flex-col md:flex-row h-full w-full bg-[#BDBDBD]" id="section1">
            {/* left Section */}
            <div className="h-full md:w-1/2 flex flex-col md:flex-row justify-center items-center md:border-r md:shadow-2xl border-gray-400 relative">
                {/* Side heading */}
                ...
                {/* Content */}
                <div className="px-12 md:px-20 lg:px-32 w-full flex flex-col items-center md:items-start text-center md:text-start">
            ...
            {/* Right Section */}
            <div className="hidden md:block mt-20 md:w-2/4 relative overflow-hidden">
